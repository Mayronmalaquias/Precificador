...
def _leads_sem_contato(session, escopo, hoje) -> List[Dict[str, Any]]:
    ...
    if escopo["ve_tudo"]:
        # Diretor: so as equipes ATIVAS do cadastro. O espelho guarda o nome da empresa do
        # C2S, e duas delas nao sao equipe nossa — "Equipe Locacao" e "61 Imoveis" somavam
        # 254 pendencias (02/09/2026) que nao tinham gerente para cobrar e inflavam o
        # painel do diretor sem que ninguem pudesse resolve-las.
        #
